...
function x64Multiply(e, t) {
    ...
    o[0] &= 65535;
    console.log(e, t)
    console.log([o[0] << 16 | o[1], o[2] << 16 | o[3]])
    return [o[0] << 16 | o[1], o[2] << 16 | o[3]];
}
...
function x64hash128(t, n) {
    ...
    for (var d = 0; d < a; d += 16) {
        l = [255 & r.charCodeAt(d + 4) |
        (255 & r.charCodeAt(d + 5)) << 8 |
        (255 & r.charCodeAt(d + 6)) << 16 |
        (255 & r.charCodeAt(d + 7)) << 24,
            255 & r.charCodeAt(d) |
            (255 & r.charCodeAt(d + 1)) << 8 |
            (255 & r.charCodeAt(d + 2)) << 16 |
            (255 & r.charCodeAt(d + 3)) << 24];
